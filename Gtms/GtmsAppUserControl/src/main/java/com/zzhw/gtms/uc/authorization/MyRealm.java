package com.zzhw.gtms.uc.authorization;
...
public class MyRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
        ...
        GtmsUserEntity userEntity = userService.findByUserName(userName);
        ...
        if(userEntity != null){
            ...
            try {
                ...
                throw  new BaseException("User login authentication failed!");
