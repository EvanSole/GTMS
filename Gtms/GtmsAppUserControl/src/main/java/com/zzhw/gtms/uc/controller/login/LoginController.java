package com.zzhw.gtms.uc.controller.login;

import com.zzhw.gtms.base.main.utils.redis.RedisTemplate;
import com.zzhw.gtms.common.constants.Constants;
import com.zzhw.gtms.common.exception.BaseException;
import com.zzhw.gtms.common.utils.IPUtils;
import com.zzhw.gtms.common.utils.PwdUtils;
import com.zzhw.gtms.core.formwork.db.controller.BaseController;
import com.zzhw.gtms.core.web.ResponseResult;
import com.zzhw.gtms.em.LoginSource;
import com.zzhw.gtms.uc.authorization.CustomUserToken;
    ...
    private ResponseResult execShiroLogin(CustomUserToken token) {
        ...
        try {
            ...
            if (ae.getCause() instanceof BaseException) {
                BaseException ce = (BaseException) ae.getCause();
