...
import com.zzhw.gtms.AutoBasePO;
import com.zzhw.gtms.NormalBasePO;
import com.zzhw.gtms.autoid.IAutoIdClient;
import com.zzhw.gtms.common.constants.AutoIdConstants;
import com.zzhw.gtms.common.utils.GtmsBeanUtil;
import com.zzhw.gtms.core.formwork.db.util.AliasToMapResultTransformer;
import com.zzhw.gtms.core.formwork.db.splitdb.DbShardsUtil;
import com.zzhw.gtms.core.formwork.db.util.PoUtils;
    ...
    public T saveOrUpdate(T entity, String... splitTable) throws Exception {
        ...
        if (id == 0) {
            ...
            if (target != null) {
                ...
                GtmsBeanUtil.copyProperties(entity, target);
